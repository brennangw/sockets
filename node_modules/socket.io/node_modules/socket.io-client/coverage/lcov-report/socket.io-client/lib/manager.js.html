...
<div class="header medium">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">socket.io-client/lib/</a>
        &#187; manager.js
    </div>
</div>
<div class="body">
...
Manager.prototype.reconnection = function(v){
  <span class="missing-if-branch" title="if path not taken">I</span>if (!arguments.length) <span class="cstat-no"
                                                                                                 title="statement not covered">return this._reconnection;</span>
...
Manager.prototype.reconnectionAttempts = function(v){
  <span class="missing-if-branch" title="if path not taken">I</span>if (!arguments.length) <span class="cstat-no"
                                                                                                 title="statement not covered">return this._reconnectionAttempts;</span>
...
Manager.prototype.timeout = function(v){
  <span class="missing-if-branch" title="if path not taken">I</span>if (!arguments.length) <span class="cstat-no"
                                                                                                 title="statement not covered">return this._timeout;</span>
  this._timeout = v;
  return this;
};
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">  this.subs.push(on(socket, 'error', bind(this, 'onerror')));</span>
<span class="cstat-no"
      title="statement not covered">  this.subs.push(on(socket, 'close', bind(this, 'onclose')));</span>
};
&nbsp;
/**
 * Called with data.
...
<span class="cstat-no" title="statement not covered">    this.encoder.encode(packet, <span class="fstat-no"
                                                                                           title="function not covered">function(encodedPackets) {</span></span>
...
<span class="cstat-no"
      title="statement not covered">  if (this.packetBuffer.length &gt; 0 &amp;&amp; !this.encoding) {</span>
...
Manager.prototype.reconnect = function(){
  <span class="missing-if-branch" title="if path not taken">I</span>if (this.reconnecting) <span class="cstat-no"
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat May 31 2014
        14:57:59 GMT-0700 (PDT)
    </div>
</div>
