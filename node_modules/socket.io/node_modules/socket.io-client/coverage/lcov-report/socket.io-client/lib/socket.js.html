...
Socket.prototype.connect = function(){
  <span class="missing-if-branch" title="if path not taken">I</span>if (this.connected) <span class="cstat-no"
  ...
  <span class="missing-if-branch" title="if path not taken">I</span>if ('open' == this.io.readyState) <span
        class="cstat-no" title="statement not covered">this.onopen();</span>
  return this;
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered">  if (hasBin(args)) { <span class="cstat-no"
                                                                                 title="statement not covered">parserType = parser.BINARY_EVENT; </span>} </span>// binary
...
<span class="cstat-no" title="statement not covered">  if (packet.nsp != this.nsp) <span class="cstat-no"
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    var type = hasBin(args) ? parser.BINARY_ACK : parser.ACK;</span>
