...
function parse(uri){
  var obj = uri;
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (null == url) <span class="cstat-no"
                                                                                           title="statement not covered">url = location.protocol + '//' + location.hostname;</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Dec 25 2013
        13:39:19 GMT-0300 (ART)
    </div>
</div>
